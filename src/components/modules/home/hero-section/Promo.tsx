  ...
  return (
    <section className="grid grid-cols-1 gap-2 md:gap-4">
      ...
      <div className="grid grid-cols-12 gap-2 md:gap-4 h-28 md:h-[196px] xl:h-60">
        {/* left */}
        <div className="col-span-7 h-full relative bg-gradient-to-r from-[#E0E1FC] to-[#F1ECD7] rounded-[20px]">
        ...
        {/* right Men Shirt */}
        <div className="col-span-5 h-full relative bg-gradient-to-r from-[#F1ECD7] to-[#E0E1FC] rounded-[20px]">
      ...
      <div className="grid grid-cols-3 gap-2 md:gap-4 h-48 md:h-[410px] xl:h-[450px]">
        {/* left */}
        <div className="h-full relative rounded-[20px] bg-gray-100">
          <SmartImage
        ...
        <div className="flex flex-col h-full gap-2 md:gap-4">
          <div className="h-1/2 relative rounded-[20px] bg-gray-100">
            <SmartImage
              ...
              priority
            />
            <button className="absolute bottom-2 md:bottom-6 left-1/2 -translate-x-1/2 bg-[#CDCDCD61] px-2 py-1 md:px-6 md:py-3 rounded-md md:rounded-[12px] flex items-center gap-2 text-[10px] md:text-sm font-medium shadow whitespace-nowrap">
              See Watch <ChevronRight className="w-4 h-4" />
            </button>
          </div>

          <div className="h-1/2 relative rounded-[20px] bg-gradient-to-br from-[#FFC66B] via-[#FFC66B] to-[#FFFFFF]">
            <SmartImage
