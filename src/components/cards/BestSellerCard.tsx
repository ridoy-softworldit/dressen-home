...
const BestSellerCard = ({
  ...
  return (
    <div
      className="group rounded-2xl overflow-hidden bg-[#EEEEEE] border-none
     relative"
    >
      ...
      <div
        className="font-medium absolute bottom-4 md:bottom-7 xl:bottom-10 left-1/2 -translate-x-1/2 
                bg-gradient-to-r from-[#18191933] via-[#1819198c] to-[#18191933]
      ...
      >
        ...
        {subtitle && (
          <p className="text-[6px] md:text-[10px] lg:text-[8px] xl:text-[10px] text-[#EEEEEE] ">
            {subtitle}
          </p>
        )}
      </div>
      ...
      <NextLink
        ...
        className=" bg-black text-white p-0.5 md:p-2 rounded-full 
